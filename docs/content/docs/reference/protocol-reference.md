...
See [Durable Queues — AMQP 0.9.1](/messaging/durable-queues#amqp-091) for full details.
...
See [HTTP client](/clients/http) for usage.
...
- [Queue Types](/concepts/queues)
- [Server configuration](/configuration/server)
- [MQTT client](/clients/mqtt)
