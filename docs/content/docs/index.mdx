...
Prefer Docker? See [Quick Start (Docker)](/getting-started/quick-start-docker).
...
<Cards>
  <Card
    ...
    href="/getting-started/quick-start-docker"
  ...
  <Card
    title="Messaging"
    href="/messaging/publishing-messages"
  ...
  <Card
    title="Reference"
    href="/reference/configuration-reference"
